...
void clientWidget::on_connect_btn_clicked()
{
...
void clientWidget::on_choose_btn_clicked()
{
...
void clientWidget::on_send_btn_clicked()
{
    this->sent_data = 0;
...
void clientWidget::on_close_btn_clicked()
{
    this->tcp_socket->disconnectFromHost();
}
